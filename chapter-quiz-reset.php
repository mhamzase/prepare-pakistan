...
$sql_result = mysqli_query($conn, "SELECT * FROM results WHERE user_id = '$sql_user_result[id]' and status = 'current' ");
...
if ($found) {
    ...
    $sql_update = mysqli_query($conn, "UPDATE results SET status = 'finished' WHERE id = '$sql_fetch_result[id]'");
}
