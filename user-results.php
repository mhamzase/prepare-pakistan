...
?>
        ...
        <body style="overflow-x:hidden">
            ...
            <div class="container">
                <div class="row">
                    <h3 class="text-warning text-center">Previous Chapter Quiz Results</h3>
                </div>
                <table class="table table-hover mt-5">
                    ...
                    <tbody>
                        ...
                        $sql_results = mysqli_query($conn, "SELECT * FROM results WHERE user_id = '$user_data[id]' ORDER BY id DESC");
                ...
                <div class="row mt-5">
                    <h3 class="text-warning text-center">Previous Full Paper Test Results</h3>
                </div>
                <table class="table table-hover mt-5">
                    <thead class="bg-primary">
                        <tr class="text-center">
                    ...
                    <tbody>
                        ...
                        $sql_results = mysqli_query($conn, "SELECT * FROM test_results WHERE user_id = '$user_data[id]' ORDER BY id DESC");
