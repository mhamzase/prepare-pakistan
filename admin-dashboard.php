...
?>
        ...
        <body>
            ...
            <div class="container-fluid m-5">
                ...
                <a href="add-subjects.php"><button type="button" class="btn btn-outline-info btn-lg "><i class="bi bi-book-half m-3"></i>Add Subjects</button></a>
                <a href="add-chapters.php"><button type="button" class="btn btn-outline-info btn-lg "><i class="bi bi-journal-bookmark-fill m-3"></i>Add Chapters</button></a>
                <a href="add-quizes.php"><button type="button" class="btn btn-outline-info btn-lg "><i class="bi bi-card-list m-3"></i>Add Quiz's</button></a>
                <?php
                if ($db_type == 0) {
                ?>
