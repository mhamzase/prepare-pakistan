...
<body style="overflow-x:hidden">
        ...
        <div class="container py-5">
            <div class="row h-100 align-items-center py-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-muted mb-0"> Prepare Pakistan is a website where you can test your skills to take tests with various type of Tests & Subjects.</p>
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                    <h2 class="text-dark">Lorem ipsum dolor sit amet</h2>
    ...
    <div class="bg-light py-5 mb-1">
        <div class="container py-5">
            <div class="row mb-4">
                <div class="col-lg-5">
                    <h2 class="display-4 text-dark">Our team</h2>
                    <p class="font-italic text-dark">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                </div>
            </div>
